...
<title>Authors Christine & Ethan Rose</title>
...
<td>
					<a href="http://www.rowanofthewood.com">Rowan of the Wood</a>&nbsp;-&nbsp;
				</td>


				<td>
					<a href="http://www.ethanroseconstruction.com">Rose Construction</a>&nbsp;-&nbsp;
				</td>
				<td>
					<a href="http://www.bluemoosefilms.com">Blue Moose</a>&nbsp;-&nbsp;
				</td>

				<td>
					<a href="mailto:christine@bluemoosefilms.com">Contact</a>
				</td>
			</tr>
		</table>
	</div>
	...
	<div id="menu_pad">
		<table cellpadding="0" cellspacing="0">
			<tr>
				...
				<td class="sep">|</td>
				<td class="menu">
					<a href="?page_id=73">art</a>
				</td>
				<td class="sep">|</td>
				<td class="menu">
					<a href="?page_id=40">faq & links</a>
				</td>
			</tr>
		</table>
	</div>
