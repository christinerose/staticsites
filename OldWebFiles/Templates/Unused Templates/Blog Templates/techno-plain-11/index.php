		...
		<?php while (have_posts()) : the_post(); ?>
			...
			<div class="post<?php if(is_home() && $post==$posts[0] && !is_paged()) echo ' firstpost';?>">
				...
				<div class="entry">
					...
					<div class="postfooter"><small>By <b><?php the_author() ?></b> in <?php the_category(',') ?>&nbsp;<?php edit_post_link(' (Edit...) ','',' '); ?>  .::.  <?php comments_popup_link('(<u>Add your comment</u>)', '<u>Read Comment (1)</u>', '<u>Read Comments (%)</u>'); ?></small></div>
				</div>
<br class="clearing" />
			</div>
