...
?>
    ...
    <div id="StartBaloon">
  <img src="<?php bloginfo('template_directory'); ?>/images/ardn_16.png" alt="\/" /> <?php _e('More Options ...','inanis');?>
</div>
...
<div id="StartMenu" onclick="SMClkd();">
  ...
  <div class="SMMiddle">
    <div class="SMsub">
      ...
      <div class="SMsgb" onclick="SMRaise(3);"><a href="javascript:void(0);"><img src="<?php bloginfo('template_directory'); ?>/images/smfwd.png" alt=" " /><?php _e('Last 50 Posts','inanis');?></a></div>
    ...
    <div class="SMsub SMsh" id="SMSub1">
      <div class="SMSubDiv" style="padding:0;margin:4px 0 0 4px;">
        ...
        <div class="SMsgbhr"><img src="<?php bloginfo('template_directory'); ?>/images/smhrlt.png" alt=" " /></div>
        <div class="SMsgb" onclick="SMLower(1);"><a href="javascript:void(0);"><img src="<?php bloginfo('template_directory'); ?>/images/smback.png" alt=" " /><?php _e('Back','inanis');?></a></div>
      </div>
    </div>
    ...
    <div class="SMsub SMsh" id="SMSub2">
      <div class="SMSubDiv" style="padding:0;margin:4px 0 0 4px;">
        ...
        <div class="SMsgbhr"><img src="<?php bloginfo('template_directory'); ?>/images/smhrlt.png" alt=" " /></div>
        <div class="SMsgb" onclick="SMLower(2);"><a href="javascript:void(0);"><img src="<?php bloginfo('template_directory'); ?>/images/smback.png" alt=" " /><?php _e('Back','inanis');?></a></div>
      </div>
    </div>
    ...
    <div class="SMsub SMsh" id="SMSub3">
      <div class="SMSubDiv SMap">
        ...
        <div class="SMsgbhr"><img src="<?php bloginfo('template_directory'); ?>/images/smhrlt.png" alt=" " /></div>
        <div class="SMsgb" onclick="SMLower(3);"><a href="javascript:void(0);"><img src="<?php bloginfo('template_directory'); ?>/images/smback.png" alt=" " /><?php _e('Back','inanis');?></a></div>
      </div>
    </div>
    ...
    ?>
      ...
      <div class="SMRtPoCom" onclick="SMFlot(5);"><?php _e('Change Theme...','inanis');?></div>
