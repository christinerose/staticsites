...
<!-- You can start editing here. -->
        ...
        <div class="p1">
          <?php if ($comments) : ?>
            ...
            <?php else : // this is displayed if there are no comments so far ?> 
              ...
              <p class="nocomments" style="text-align:center;margin:35px 0 35px 0;"><?php _e('Sorry, but comments are closed. Check out another post and speak up!','inanis');?></p>
            <?php endif; ?>
          <?php endif; ?>
      ...
      <div class="alignright">
        <div class="PTtop"><img src="<?php bloginfo('template_directory'); ?>/images/1pxtrans.gif" alt=" " /></div>
        <div class="PTbar">
           <div class="PT PTds"><span class="ptblurl">&nbsp;</span><h3><a name="post"></a><?php _e('Leave A Comment','inanis');?> ...</h3><span class="ptblurr">&nbsp;</span></div>
        </div>
        <div class="PTbtm"><img src="<?php bloginfo('template_directory'); ?>/images/1pxtrans.gif" alt=" " /></div>
        <div class="p1">
